...
const HAND_PATTERNS: HandPattern[] = [
  { id: 'openai-project-key', label: 'OpenAI project API key', providerId: 'openai', source: `sk-proj-${SW}{40,}` },
  { id: 'anthropic-api03', label: 'Anthropic API key', providerId: 'anthropic', source: `sk-ant-api03-${SW}{80,}` },
  { id: 'github-pat', label: 'GitHub personal access token', providerId: 'github', source: `ghp_${SW}{36}` },
  { id: 'github-oauth', label: 'GitHub OAuth access token', providerId: 'github', source: `gho_${SW}{36}` },
  { id: 'github-user', label: 'GitHub user-to-server token', providerId: 'github', source: `ghu_${SW}{36}` },
  { id: 'github-app', label: 'GitHub server-to-server token', providerId: 'github', source: `ghs_${SW}{36}` },
  { id: 'github-fine-grained', label: 'GitHub fine-grained token', providerId: 'github', source: `github_pat_[A-Za-z0-9_]{80,}` },
  { id: 'gitlab-pat', label: 'GitLab personal access token', providerId: 'gitlab', source: `glpat-${SW}{20}` },
  ...
  { id: 'slack-bot', label: 'Slack bot token', providerId: 'slack', source: `xoxb-${SW}{40,}` },
  { id: 'slack-user', label: 'Slack user token', providerId: 'slack', source: `xoxp-${SW}{40,}` },
  { id: 'slack-app', label: 'Slack app-level token', providerId: 'slack', source: `xoxa-${SW}{16,}` },
  { id: 'slack-app-env', label: 'Slack app env token', providerId: 'slack', source: `xapp-${SW}{80,}` },
  { id: 'digitalocean', label: 'DigitalOcean API token', providerId: 'digitalocean', source: `dop_v1_[A-Za-z0-9_]{64,}` },
  { id: 'shopify', label: 'Shopify access token', providerId: 'shopify', source: `shpat_[A-Za-z0-9_]{32,}` },
  ...
  { id: 'groq', label: 'Groq API key', providerId: 'groq', source: `gsk_[A-Za-z0-9_]{52,}` },
  { id: 'openrouter-v1', label: 'OpenRouter v1 key', providerId: 'openrouter', source: `sk-or-v1-${SW}{64,}` },
